...
public class SecurityLocksCommon {
	...
	public static final String ServerAddress = "https://secure. .net/php/web/FLPhoneUsersPwdRecovery.php";
...
//    public static String AppName =  "/Vault Hack Attempts/";
...
//	public static String HackAttempts ="/HackAttempts/";
    ...
    public static String AppName =  "/PrivateBrowser Intruders/";
    public static String StoragePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/data" + AppName;
    public static String HackAttempts ="/BrowserIntruderSelfie/";
