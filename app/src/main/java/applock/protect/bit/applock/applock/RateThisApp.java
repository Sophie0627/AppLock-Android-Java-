...
public class RateThisApp {
	 ...
	 */
	public static void onStart(Context context,boolean online) {
	...
	public static void showRateDialog(final Context context) {
		...
		if(!Common.IsRateDialogShowing){
			...
			dialog.setContentView(R.layout.custom_rate_dialog); //I saved the xml file above as yesnomessage.xml
			...
			Button  RateNow = (Button) dialog.findViewById(R.id.btnRateNow);
		    ...
		    Button  RemindLater = (Button) dialog.findViewById(R.id.btnRemindLater);
	...
	private static void clearSharedPreferences(Context context) {
		SharedPreferences pref = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
		Editor editor = pref.edit();
		//editor.putLong(KEY_INSTALL_DATE, 0);
